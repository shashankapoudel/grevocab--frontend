...
const Home = () => {
    ...
    return (
        ...
        <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 md:gap-5 p-4 md:p-8 lg:p-12 min-h-screen bg-[#F7F7F9] '>
            <div className='flex justify-center items-center bg-[#FFFFFF]  sm:mt-6  mt-7  p-4 w-full shadow-xl '>
            ...
            <div className='flex justify-center items-center bg-[#FFFFFF] mt-10 sm:mt-6 p-4 w-full shadow-xl'>
